...
#ifndef _apt32f110_rtc_H
#define _apt32f110_rtc_H
...
/*********************************************************************** 
 @brief  RTC Registers Reset Value                 
***********************************************************************/ 
...
typedef enum
{
	...
	CLKSRC_ESOSC				=	 	(CSP_REGISTER_T)(0x02ul<<24),
...
extern void RTC_Function_Config(RTC_FMT_MODE_TypeDef RTC_FMT_MODE , RTC_CPRD_TypeDef RTC_CPRD_x );
