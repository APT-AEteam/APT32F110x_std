...
#ifndef _apt32f110_ept_H
#define _apt32f110_ept_H
...
/*********************************************************************** 
 @brief  EPT Syncusr0 ExtSync Selecte
***********************************************************************/ 
typedef enum		
{
...
/*********************************************************************** 
 @brief  EPT TRGSRC1 ExtSync Selecte
***********************************************************************/ 
typedef enum		
{
...
/*********************************************************************** 
 @brief  EPT Input select 
***********************************************************************/
typedef enum	
{
	EPT_Input_selecte_EBI0			=		((CSP_REGISTER_T)(1)),	//EBI0	
	EPT_Input_selecte_EBI1			=		((CSP_REGISTER_T)(2)),	//EBI1
	EPT_Input_selecte_EBI2			=		((CSP_REGISTER_T)(3)),	//EBI2
	EPT_Input_selecte_EBI3			=		((CSP_REGISTER_T)(4)),	//EBI3
	EPT_Input_selecte_LVD			=		((CSP_REGISTER_T)(5)),	//LVD
	EPT_Input_selecte_CMP			=		((CSP_REGISTER_T)(6)),	//CMP
...
typedef enum
{
	...
	EPT_LinkREG_GLD2	=	4,
	EPT_LinkREG_RSSR	=	5,
	EPT_LinkREG_EMSLCLR	=	6,
	EPT_LinkREG_EMHLCLR	=	7,
	EPT_LinkREG_EMICR	=	8,
	EPT_LinkREG_EMFRCR	=	9,
	EPT_LinkREG_AQOSF	=	10,
	EPT_LinkREG_AQCSF	=	11
}EPT_LinkREG_TypeDef;	
/*********************************************************************** 
 @brief EPT LinkREG IP Selecte
***********************************************************************/
typedef enum
{
	EPT0_DIS_LINK	=	0,
	...
	EPT0_GPTB0_LINK	=	4,
	EPT0_GPTB1_LINK	=	5
}EPT_LinkREG_IP_Selecte_TypeDef;	

/*********************************************************************** 
 @brief  EPT extern functions                  
***********************************************************************/ 
extern void EPT_Software_Reset(void);
...
extern void EPT_SYNCR_Config(U8_T EPT_Triggle_Mode , EPT_SYNCUSR0_REARMTrig_Selecte_Type EPT_SYNCUSR0_REARMTrig_Selecte , EPT_TRGSRC0_ExtSync_Selected_Type EPT_TRGSRC0_ExtSync_Selected ,
...
extern void EPT_EBIX_POL_Config(U8_T EPT_EBIX_POL);
...
extern void EPT_REG_LINK_CONFIG(EPT_LinkREG_TypeDef EPT_LinkREG_X, EPT_LinkREG_IP_Selecte_TypeDef EPT_LinkREG_IP_Selecte_X);

#endif   // apt32f110_ept_H */
