...
void SIO_IO_Init(SIO_IOG_TypeDef IOGx)
{
	if(IOGx==SIO_PC0_0)
	{
		GPIOC0->CONLR=(GPIOC0->CONLR & 0XFFFFFFF0)|0x00000004;
	}
	if(IOGx==SIO_PA0_1)
	{
		GPIOA0->CONLR=(GPIOA0->CONLR & 0XFFFFFF0F)|0x00000070;
	}
	if(IOGx==SIO_PA0_3)
	{
	...
	if(IOGx==SIO_PA0_5)
	{
		GPIOA0->CONLR=(GPIOA0->CONLR & 0XFF0FFFFF)|0x00600000;
	}
	if(IOGx==SIO_PB0_1)
	{
...
//ReturnValue:NONE
/*************************************************************/ 
void SIO_TXBUF_Send(U8_T D30,U8_T D28,U8_T D26,U8_T D24,U8_T D22,U8_T D20,U8_T D18,U8_T D16,
...
void SIO_RX_Configure0(SIO_BSTSEL_TypeDef BSTSELX,SIO_TRGMODE_TypeDef TRGMX,U8_T SPLCNTX,U8_T EXTRACTX,U8_T HITHRX,
					SIO_ALIGNEN_TypeDef ALIGNX,SIO_RXDIR_TypeDef RXDIRX,SIO_RXMODE_TypeDef RXMODEX,U8_T RXCNTX,U8_T RXBUFCNTX,U8_T RXKPRSX)
{
	SIO0->RXCR0=BSTSELX|TRGMX|(SPLCNTX<<4)|(EXTRACTX<<10)|(HITHRX<<16)|(ALIGNX)|RXDIRX|RXMODEX;			
	SIO0->RXCR1=(RXCNTX)|(RXBUFCNTX<<8)|(RXKPRSX<<16);												
}
/*************************************************************/
//SIO RX Configure 1
//EntryParameter:NONE
