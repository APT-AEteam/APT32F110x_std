...
void ADC12_Configure_VREF_Selecte(ADC12_VREFP_VREFN_Selected_TypeDef ADC12_VREFP_X_VREFN_X )
{
	...
	{
		GPIOC0->CONLR = (GPIOC0->CONLR&0XFFFFFFF0)  | 0x00000009;	
...
void ADC12_Configure_Intvref_Selecte(ADC12_Intvref_Selected_TypeDef ADC12_Intvref_x_TypeDef , ADC12_Intvref_ouput_cmd_TypeDef ADC12_Intvref_ouput_cmd )
{
	if(ADC12_Intvref_ouput_cmd==ADC12_Intvref_ouput_en)
	{
		GPIOA0->CONLR = (GPIOA0->CONLR&0XFFF0fFFF)  | 0x00090000;				//IntVref
	}
	if(ADC12_Intvref_x_TypeDef==Intvref_sel_1v)
	{
		ADC0->CR=(ADC0->CR&0xfff8ffff)|(2<<17)|ADC12_Intvref_ouput_cmd;
	}
	else if(ADC12_Intvref_x_TypeDef==Intvref_sel_temp)
	{
		ADC0->CR=(ADC0->CR&0xfff8ffff)|(3<<17)|ADC12_Intvref_ouput_cmd;
	}
						...
						ADC12_CV_RepeatNum_TypeDef CV_RepeatTime, ADC12_Control_TypeDef AVG_Set, U8_T SEQx)
{
	...
	{
		case 0:	
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFFFF0)  | 0x0000000A;							//ADC0 PA0.0			
			break;
		case 1:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFFF0F)  | 0x000000A0;							//ADC1 PA0.1					
			break;
		case 2:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFF0FFF)  | 0x0000A000;							//ADC2 PA0.3
			break;
		case 3:
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFFFFF0)  | 0x0000000A;							//ADC3 PB0.0	
			break;
		case 4:
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFFFF0F)  | 0x000000A0;							//ADC4 PB0.1
			break;
		case 5:
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFFF0FF)  | 0x00000A00;							//ADC5 PB0.2	
			break;
		case 6:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XF0FFFFFF)  | 0x0A000000;							//ADC6 PA0.6
			break;
		case 7:
			GPIOA0->CONLR = (GPIOA0->CONLR&0X0FFFFFFF)  | 0xA0000000;							//ADC7 PA0.7
			break;
		case 8:						
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFFFFF0)  | 0x0000000A;							//ADC8 PA0.8
			break;
		case 9:
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFFFF0F)  | 0x000000A0;							//ADC9 PA0.9	
			break;
		case 10:
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFFF0FF)  | 0x00000A00;							//ADC10 PA0.10
			break;
		case 11:
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFFF0FFF)  | 0x0000A000;							//ADC11 PA0.11			
			break;
		case 12:
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFFF0FFFF)  | 0x000A0000;							//ADC12 PA0.12
			break;
		case 13:
			GPIOA0->CONHR = (GPIOA0->CONHR&0XFF0FFFFF)  | 0x00A00000;							//ADC13 PA0.13		
			break;
		case 14:
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFFF0FFF)  | 0x0000A000;							//ADC14 PB0.03			
			break;
		case 15:
			GPIOC0->CONLR = (GPIOC0->CONLR&0XFFFFFF0F)  | 0x000000A0;							//ADC15 PC0.1		
			break;
		case 16:
			GPIOB0->CONLR = (GPIOB0->CONLR&0XFFF0FFFF)  | 0x000A0000;							//ADC16 PB0.4		
			break;
		case 17:
			GPIOC0->CONLR = (GPIOC0->CONLR&0XFFFFFFF0)  | 0x0000000A;							//ADC17 PC0.0	
			break;
		case 18:
			GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFF0FF)  | 0x00000A00;							//ADC18 PA0.2		
			break;
		//case 20: break;
		//case 21: break;
		//case 22: break;
