...
{
	if(COUNTA_IO_G==COUNTA_PA1_7)
	{
		GPIOA1->CONLR=(GPIOA1->CONLR & 0X0FFFFFFF)|0x60000000;		
	}
	else if(COUNTA_IO_G==COUNTA_PA1_10)
	{
		GPIOA1->CONHR=(GPIOA1->CONHR & 0XFFFFF0FF)|0x00000600;	
	}
	else if(COUNTA_IO_G==COUNTA_PA1_13)
	{
		GPIOA1->CONHR=(GPIOA1->CONHR & 0XFF0FFFFF)|0x00600000;	
	}
}
