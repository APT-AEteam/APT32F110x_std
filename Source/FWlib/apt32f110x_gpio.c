...
void GPIO_DeInit(void)
{
	...
	//GPIOA1
    GPIOA1->CONLR &= 0xF0000000; 
    GPIOA1->CONHR &= 0x0000000F;
	...
	GPIOGRP->IO_CLKEN = 0X17;
}  
/*************************************************************/
//IO OUTPUT INPUT SET 2
//EntryParameter:GPIOx,byte,val
//GPIOx:GPIOA0,GPIOA1,GPIOB0,GPIOC0
...
void GPIO_CCM_EN(CSP_GPIO_T *GPIOx,uint8_t bit)
{
	(GPIOx)->OMCR  = ((GPIOx)->OMCR) | (0x01<<(bit+16));
}
void GPIO_CCM_DIS(CSP_GPIO_T *GPIOx,uint8_t bit)
{
	(GPIOx)->OMCR  = ((GPIOx)->OMCR) & ~(0x01<<(bit+16));
}
/*************************************************************/
...
//EXI0~EXI15:GPIOA0,GPIOA1,GPIOB0
//EXI16~EXI17:GPIOA0.0~GPIOA0.7; GPIOB0.0~GPIOB0.3
//EXI18~EXI19:GPIOB0.0~GPIOB0.3; GPIOC0.0~GPIOC0.1
//ReturnValue:NONE
/*************************************************************/  
void GPIO_IntGroup_Set(GPIO_Group_TypeDef IO_MODE , uint8_t PinNum , GPIO_EXIPIN_TypeDef Selete_EXI_x)
{
	...
	else if(Selete_EXI_x<20)
	{
		if(Selete_EXI_x==16)
		{
			...
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|(PinNum+0XC);
			}
		}
		else if(Selete_EXI_x==17)
		{
			...
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|((PinNum+8)<<4);
			}
			else if(IO_MODE==PC0)
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|((PinNum+0XC)<<4);
			}
		}
		else if(Selete_EXI_x==18)
		{
			if(IO_MODE==PB0)
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|(PinNum<<8);
			...
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|((PinNum+4)<<8);
			}
		}
		else if(Selete_EXI_x==19)
		{
			...
			{
				GPIOGRP->IGREX =(GPIOGRP->IGREX)|((PinNum+4)<<12);
			}
		}
	}
}
...
void GPIOA1_EXI_Init(GPIO_EXI_TypeDef EXI_IO)
{
    switch (EXI_IO)
    {
        case 0:GPIOA1->CONLR = (GPIOA1->CONLR&0XFFFFFFF0) | 0X00000001;break;
        case 1:GPIOA1->CONLR = (GPIOA1->CONLR&0XFFFFFF0F) | 0X00000010;break;
        case 2:GPIOA1->CONLR = (GPIOA1->CONLR&0XFFFFF0FF) | 0X00000100;break;
        case 3:GPIOA1->CONLR = (GPIOA1->CONLR&0XFFFF0FFF) | 0X00001000;break;
        case 4:GPIOA1->CONLR = (GPIOA1->CONLR&0XFFF0FFFF) | 0X00010000;break;
        case 5:GPIOA1->CONLR = (GPIOA1->CONLR&0XFF0FFFFF) | 0X00100000;break;
        case 6:GPIOA1->CONLR = (GPIOA1->CONLR&0XF0FFFFFF) | 0X01000000;break;
        case 7:GPIOA1->CONLR = (GPIOA1->CONLR&0X0FFFFFFF) | 0X10000000;break;
        case 8:GPIOA1->CONHR = (GPIOA1->CONHR&0XFFFFFFF0) | 0X00000001;break;
        case 9:GPIOA1->CONHR = (GPIOA1->CONHR&0XFFFFFF0F) | 0X00000010;break;
        case 10:GPIOA1->CONHR = (GPIOA1->CONHR&0XFFFFF0FF) | 0X00000100;break;
        case 11:GPIOA1->CONHR = (GPIOA1->CONHR&0XFFFF0FFF) | 0X00001000;break;
        case 12:GPIOA1->CONHR = (GPIOA1->CONHR&0XFFF0FFFF) | 0X00010000;break;
        case 13:GPIOA1->CONHR = (GPIOA1->CONHR&0XFF0FFFFF) | 0X00100000;break;
		case 14:break;
		case 15:break;
    }
}
void GPIOB0_EXI_Init(GPIO_EXI_TypeDef EXI_IO)
{
    switch (EXI_IO)
    {
		...
		case 6:GPIOB0->CONLR = (GPIOB0->CONLR&0XF0FFFFFF) | 0X01000000;break;
        case 7:GPIOB0->CONLR = (GPIOB0->CONLR&0X0FFFFFFF) | 0X10000000;break;
        case 8:GPIOB0->CONHR = (GPIOB0->CONHR&0XFFFFFFF0) | 0X00000001;break;
        case 9:GPIOB0->CONHR = (GPIOB0->CONHR&0XFFFFFF0F) | 0X00000010;break;
        case 10:GPIOB0->CONHR = (GPIOB0->CONHR&0XFFFFF0FF) | 0X00000100;break;
        case 11:GPIOB0->CONHR = (GPIOB0->CONHR&0XFFFF0FFF) | 0X00001000;break;
        default:break;
    }
}
