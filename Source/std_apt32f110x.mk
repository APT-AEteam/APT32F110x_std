...
##
## BuildSet
ProjectName            :=std_apt32f110x
ConfigurationName      :=BuildSet
WorkspacePath          :=../Workspace/APT32F110x_StdPeriph_Lib/
ProjectPath            :=./
...
OutputFile             :=apt32f110_std_release
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
PreprocessOnlySwitch   :=-E
ObjectsFileList        :=std_apt32f110x.txt
...
Libs                   := -Wl,--start-group  -Wl,--end-group $(LibrarySwitch)_110tkey_c_1_04  
ArLibs                 := "lib_110tkey_c_1_04" 
PackagesLibPath        :=
...
CXXFLAGS := -mcpu=ck802   $(PreprocessorSwitch)CONFIG_CSKY_MMU=0   $(UnPreprocessorSwitch)__CSKY_ABIV2__  -Os  -g  -Wall  -ffunction-sections -mistack 
CFLAGS   := -mcpu=ck802   $(PreprocessorSwitch)CONFIG_CSKY_MMU=0   $(UnPreprocessorSwitch)__CSKY_ABIV2__  -Os  -g  -Wall  -ffunction-sections -mistack 
