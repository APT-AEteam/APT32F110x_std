...
#ifndef _apt32f110_sio_H
#define _apt32f110_sio_H
...
/*********************************************************************** 
 @brief  SIO INT MASK SET/CLR  Set
***********************************************************************/
typedef enum
{
	SIO_TXDNE     	=	(0x01 << 0),  
...
extern void SIO_TXBUF_Send(U8_T D30,U8_T D28,U8_T D26,U8_T D24,U8_T D22,U8_T D20,U8_T D18,U8_T D16,
