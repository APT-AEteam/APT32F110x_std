...
{
	GPIOA0->CONLR = (GPIOA0->CONLR&0XFFFFFFF0)|0X00000004;
	RTC->KEY=0XCA53;
...
void RTCCLK_CONFIG(U16_T DIVS , U16_T DIVA , RTC_CLKSRC_TypeDef CLKSRC_X)
{
	RTC->KEY=0XCA53;
	RTC->CCR &= ~(0X01<<27);
	RTC->CCR=(RTC->CCR&0xfc000000)|DIVS|(DIVA<<16)|(0X01<<23)|CLKSRC_X|(0X01<<27);
...
//ReturnValue:NONE
/*************************************************************/ 
void RTC_Function_Config(RTC_FMT_MODE_TypeDef RTC_FMT_MODE , RTC_CPRD_TypeDef RTC_CPRD_x )
{
	RTC->KEY=0XCA53;
	RTC->CR=(RTC->CR&0xffff1cdf)|RTC_FMT_MODE|RTC_CPRD_x|0X01<<16;//enable read	
	while(RTC->CR&0x02);					
}
/*************************************************************/
...
/*************************************************************/
//Deinitializes the RTC Read dis
//EntryParameter:
//ReturnValue:NONE
/*************************************************************/
void RTC_Read_dis(void)
{
	RTC->CR&=~(0X01<<16);
	while(RTC->CR&0x02);
}
void RTC_Read_en(void)
{
	RTC->CR|=0X01<<16;
	while(RTC->CR&0x02);
}
