...
/*************************************************************/
//LPT IO Init
//EntryParameter:LPT_INOUT_PA01,LPT_INOUT_PA04,LPT_INOUT_PA07,LPT_INOUT_PA012,LPT_INOUT_PA18
//ReturnValue:NONE
/*************************************************************/
void LPT_IO_Init(LPT_IOSET_TypeDef IONAME)
{
	if(IONAME==LPT_INOUT_PA0_1)
	{
		GPIOA0->CONLR=(GPIOA0->CONLR & 0XFFFFFF0F)|0x00000050;
	}
	if(IONAME==LPT_INOUT_PA0_7)
	{
		GPIOA0->CONLR=(GPIOA0->CONLR & 0X0FFFFFFF)|0x50000000;
	}
	if(IONAME==LPT_INOUT_PA0_12)
	{
		GPIOA0->CONHR=(GPIOA0->CONHR & 0XFFF0FFFF)|0x00070000;
	}
	if(IONAME==LPT_INOUT_PA1_8)
	{
		GPIOA1->CONHR=(GPIOA1->CONHR & 0XFFFFFFF0)|0x00000007;
	}
	if(IONAME==LPT_INOUT_PA0_4)
	{
...
//ReturnValue:NONE
/*************************************************************/
void LPT_ControlSet_Configure(LPT_OUT_CMD_TypeDef LPT_OUT_CMD,LPT_SWSYN_TypeDef SWSYNX,LPT_IDLEST_TypeDef IDLESTX,LPT_PRDLD_TypeDef PRDLDX,LPT_POL_TypeDef POLX,
							 LPT_FLTDEB_TypeDef FLTDEBX,LPT_PSCLD_TypeDef PSCLDX,LPT_CMPLD_TypeDef CMPLDX)
{
	LPT->CR |= LPT_OUT_CMD|SWSYNX| IDLESTX| PRDLDX| POLX| FLTDEBX| FLTDEBX| CMPLDX|(0x01<10);
}
/*************************************************************/
//LPT SYNC Init
//EntryParameter:
...
//ReturnValue:NONE
/*************************************************************/
void LPT_WakeUp_Enable(void)
{
	INTC_IWER_WRITE(LPT_INT);  
}
/*************************************************************/
//LPT Wake up disable
//EntryParameter:NONE
//ReturnValue:NONE
/*************************************************************/
void LPT_WakeUp_Disable(void)
{
	INTC_IWDR_WRITE(LPT_INT);    
}
