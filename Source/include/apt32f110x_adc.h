...
#ifndef APT32F110X_ADC_H
#define APT32F110X_ADC_H
...
/***********************************************************************
@brief ADC12 Registers reset value
***********************************************************************/ 
...
typedef enum
{
	ADC12_12BIT     	=		0,           								// 12bit mode            
	ADC12_10BIT    	 	=		1,           								// 10bit mode            
...
typedef enum
{
	 ...
	 ADC12_ADCIN13       =	(CSP_REGISTER_T)(0x0Dul),                   // ADC Analog Input 1
	 ADC12_ADCIN14       =	(CSP_REGISTER_T)(0x0Eul),                    // ADC Analog Input 
	 ADC12_ADCIN15       =	(CSP_REGISTER_T)(0x0Ful),                   // ADC Analog Input 1
	 ADC12_ADCIN16       =	(CSP_REGISTER_T)(0x10ul),                    // ADC Analog Input 
	 ...
	 ADC12_DIV5_VDD		  =	(CSP_REGISTER_T)(0x1Dul),
...
/*********************************************************************** 
 @brief  ADC12 Intvref Selected                     
***********************************************************************/ 
typedef enum
{
	Intvref_sel_1v			=1,
	Intvref_sel_temp		=2
}ADC12_Intvref_Selected_TypeDef;
/*********************************************************************** 
 @brief  ADC12 Intvref ouput cmd                   
***********************************************************************/ 
typedef enum
{
	ADC12_Intvref_ouput_en	=	0x01<<16,
	ADC12_Intvref_ouput_dis	=	0x00<<16
}ADC12_Intvref_ouput_cmd_TypeDef;
/*********************************************************************** 
 @brief  ADC12 extern functions                  
***********************************************************************/ 
...
extern void ADC12_Configure_Intvref_Selecte(ADC12_Intvref_Selected_TypeDef ADC12_Intvref_x_TypeDef , ADC12_Intvref_ouput_cmd_TypeDef ADC12_Intvref_ouput_cmd );
