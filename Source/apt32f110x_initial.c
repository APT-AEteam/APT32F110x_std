...
void BT_CONFIG(void)
{
	...
	BT_Configure(BT0,BTCLK_EN,16,BT_IMMEDIATE,BT_CONTINUOUS,BT_PCLKDIV);//TCLK=PCLK/(0+1)
	BT_ControlSet_Configure(BT0,BT_START_HIGH,BT_IDLE_LOW,BT_CNTRLD_EN);
	BT_Period_CMP_Write(BT0,4800,2400);				//BT0 period and comparison value setting
